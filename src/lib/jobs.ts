...
export function convertScrapedJobToJobData(scraped: ScrapedJobData): JobData {
  ...
  return {
    ...
    application: {
      url: scraped.apply_url || scraped.application_url || scraped.url || scraped.link || scraped.applyLink || scraped.job_url || scraped.jobUrl || scraped.applyUrl || scraped.application_link || scraped.apply_link || scraped.external_url || scraped.job_link || scraped.apply_link_url || scraped.posting_url || scraped.sourceUrl || undefined,
      method: (scraped.apply_url || scraped.application_url || scraped.url || scraped.link || scraped.applyUrl || scraped.application_link || scraped.apply_link || scraped.external_url || scraped.job_link || scraped.apply_link_url || scraped.posting_url || scraped.sourceUrl) ? 'external' : undefined,

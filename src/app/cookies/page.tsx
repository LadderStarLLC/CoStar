  ...
  return (
    <LegalPage
      ...
      sections={[
        ...
        { title: '3. Your choices', body: <p>You can control many cookies through browser settings. Blocking required authentication, Firebase, or Stripe storage may prevent sign-in, billing, profile, messaging, or interview features from working. Some jurisdictions may provide additional opt-out rights for analytics or advertising technologies where applicable.</p> },

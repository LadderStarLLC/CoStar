...
export const metadata: Metadata = {
  ...
  description: 'Rules for using LadderStar responsibly across profiles, jobs, messaging, AI interview practice, and platform access.',
};
  ...
  return (
    <LegalPage
      ...
      sections={[
        ...
        { title: '4. AI interview misuse', body: <p>Do not use AI interview tools to generate unlawful, discriminatory, deceptive, infringing, or harmful content. Do not submit confidential third-party information, trade secrets, health information, government identifiers, or content you lack authority to share.</p> },

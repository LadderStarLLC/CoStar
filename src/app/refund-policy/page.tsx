...
export default function RefundPolicyPage() {
  return (
    <LegalPage
      ...
      sections={[
        { title: '1. Subscriptions', body: <p>Paid plans renew on the billing cycle selected at checkout unless canceled. Stripe may process checkout, payment methods, invoices, and subscription management. Plan features, prices, discounts, sales, and limits are presented in the pricing and checkout experience. Published price changes generally apply to new checkout sessions and do not automatically reprice an existing active Stripe subscription.</p> },
